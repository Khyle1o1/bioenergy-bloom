...
CREATE TABLE public.student_progress (
  ...
  pre_test_completed BOOLEAN NOT NULL DEFAULT false,
  ...
  lesson1_score INTEGER NOT NULL DEFAULT 0,
  lesson1_assessment_completed BOOLEAN NOT NULL DEFAULT false,
  lesson2_completed BOOLEAN NOT NULL DEFAULT false,
  lesson2_score INTEGER NOT NULL DEFAULT 0,
  lesson2_assessment_completed BOOLEAN NOT NULL DEFAULT false,
  lesson3_completed BOOLEAN NOT NULL DEFAULT false,
  lesson3_score INTEGER NOT NULL DEFAULT 0,
  lesson3_assessment_completed BOOLEAN NOT NULL DEFAULT false,
